...
export default function Home() {
  ...
  if (barStyle.width === '100%') {
    setTimeout(() => {
      router.push('https://chat.whatsapp.com/In3AEByViP2F46Ut6hBZAF')
    }, 500)
  }

  return (
    <main className="w-full h-screen flex items-center justify-center bg-zinc-100">
      <div className="relative flex flex-col text-center items-center justify-center h-[444px] px-12 rounded-md border border-[#FFDC22]">
        ...
        <div className="relative flex justify-center items-center rounded-md w-full h-6 mt-4 bg-gray-100 overflow-hidden">
          <div className={`absolute left-0 h-full bg-[#FFDC22]`} style={barStyle}></div>
          {barStyle.width === '100%' && (
